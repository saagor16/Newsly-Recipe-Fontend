    ...
    return (
        <div className='overflow-hidden flex md:flex-row flex-col justify-between items-center sm:my-20 my-4 md:gap-20 gap-12 px-5 lg:px-10'>
            ...
            <div className='text-start sm:w-1/2'>
                ...
                <p className='text-xl mt-4 text-[#5c5c5c]'>Preheat the oven to 200°C. Spread tomato sauce on pizza dough, add toppings like smoked jackfruit, pineapple, mozzarella, and bake for 15-20 mins until golden. Garnish with fresh basil and serve warm.</p>
